...
public class ClientGunPackDownloader {
    ...
    private static Map<String, String> getDownloadHeaders() {
        ...
        map.put("X-IMGUNS-Version", FabricLoader.getInstance().getModContainer(GunMod.MOD_ID).orElseThrow().getMetadata().getVersion().getFriendlyString());
    ...
    private void displayFailScreen(MinecraftClient mc) {
        Text title = Text.translatable("gui.immersive_guns.client_gun_pack_downloader.fail.title");
        Text subTitle = Text.translatable("gui.immersive_guns.client_gun_pack_downloader.fail.subtitle");
