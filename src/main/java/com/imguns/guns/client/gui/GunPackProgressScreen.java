...
public class GunPackProgressScreen extends Screen implements ProgressListener {
    ...
    protected void init() {
        ButtonWidget button = ButtonWidget.builder(
                Text.translatable("gui.immersive_guns.client_gun_pack_downloader.background_download"), b -> this.setDone()
    ...
    public void setTitleAndTask(Text header) {
        this.header = Text.translatable("gui.immersive_guns.client_gun_pack_downloader.downloading");
    }
