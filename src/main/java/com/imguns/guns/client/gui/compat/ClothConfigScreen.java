package com.imguns.guns.client.gui.compat;
...
public class ClothConfigScreen extends Screen {
    ...
    protected void init() {
        ...
        this.message = MultilineText.create(this.textRenderer, Text.translatable("gui.immersive_guns.cloth_config_warning.tips"), 300);
        this.addDrawableChild(
                ButtonWidget.builder(Text.translatable("gui.immersive_guns.cloth_config_warning.download"), b -> openUrl(CLOTH_CONFIG_URL))
