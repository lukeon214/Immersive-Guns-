...
import com.imguns.guns.client.model.listener.camera.CameraAnimationObject;
import com.imguns.guns.client.model.listener.constraint.ConstraintObject;
import com.imguns.guns.client.model.listener.model.ModelRotateListener;
import com.imguns.guns.client.model.listener.model.ModelScaleListener;
import com.imguns.guns.client.model.listener.model.ModelTranslateListener;
...
public class BedrockAnimatedModel extends BedrockModel implements AnimationListenerSupplier {
    ...
    public void setFunctionalRenderer(String node, Function<BedrockPart, IFunctionalRenderer> function) {
        ...
        } else if (wrapper.modelRenderer() instanceof FunctionalBedrockPart functionalPart) {
