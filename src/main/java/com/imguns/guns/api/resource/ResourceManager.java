package com.imguns.guns.api.resource;
...
public final class ResourceManager {
     ...
     * @param extraFolderPath The folder to be extracted, for example, "/assets/imguns/custom/imguns_default_gun".
     *                        This indicates that the 'imguns_default_gun' folder will be extracted and placed
