...
public class CustomInterpolator implements Interpolator {
    ...
    public float[] interpolate(int indexFrom, int indexTo, float alpha) {
        AnimationChannelContent.LerpMode fromLerpMode = content.lerpModes[indexFrom];
        AnimationChannelContent.LerpMode toLerpMode = content.lerpModes[indexTo];
        ...
        } else if (fromLerpMode == AnimationChannelContent.LerpMode.CATMULLROM || toLerpMode == AnimationChannelContent.LerpMode.CATMULLROM) {
            // Catmull-Rom 插值
